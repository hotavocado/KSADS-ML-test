...
csv
    ...
    .on('end', function () {
        ...
        Object.keys(datas).forEach(form => {
            ...
            let formContextUrl = `https://raw.githubusercontent.com/hotavocado/KSADS-ML-test/master/activities/${form}/${form}_context.jsonld`;
            scoresObj = {};
            visibilityObj = {};
            variableMap = [];
...
function createFormContextSchema(form, fieldList) {
    ...
    let formContext = {};
    itemOBj[form] = `https://raw.githubusercontent.com/hotavocado/KSADS-ML-test/master/activities/${form}/items/`;
    fieldList.forEach( field => {
